...
<div class="container mt-5">
    ...
    <div class="enlaces">
        <h2>Enlaces</h2>
        <ul>
            <li><a href="piloto/piloto.php">Entidad análoga a MECÁNICO (PILOTO)</a></li>
            <li><a href="escuderia/escuderia.php">Entidad análoga a DEPARTAMENTO (ESCUDERÍA)</a></li>
            <li><a href="prueba/prueba.php">Entidad análoga a REPARACIÓN (PRUEBA)</a></li>
